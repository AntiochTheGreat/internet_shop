...
class ProductCategory(models.Model):
    """This class describes model of product category."""
...
class Product(models.Model):
    """This class describes model of product."""
...
class BasketQuerySet(models.QuerySet):
    """This class describes actions with single baskets."""
...
class Basket(models.Model):
    """This class describes model of basket."""
    ...
    def sum(self):
        """Return total cost of current quantity of single product."""
